...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Contact',
            fields=[
                ('uuid', randomslugfield.fields.RandomSlugField(blank=True, editable=False, length=10, max_length=10, primary_key=True, serialize=False, unique=True)),
                ('source', models.CharField(blank=True, max_length=255, null=True)),
                ('title', models.CharField(blank=True, choices=[('MR', 'Mr'), ('MRS', 'Mrs'), ('MS', 'Ms')], max_length=3, null=True, verbose_name='Title')),
                ...
                ('status', models.CharField(blank=True, choices=[('LEAD', 'Lead'), ('MARKETING QUALIFIED LEAD', 'Marketing Qualified Lead'), ('SALES QUALIFIED LEAD', 'Sales Qualified Lead'), ('OPPORTUNITY', 'Opportunity'), ('CUSTOMER', 'Customer'), ('DEAD', 'Dead')], default='lead', max_length=50, null=True, verbose_name='Status')),
                ('stage', models.CharField(blank=True, choices=[('QUALIFICATION', 'QUALIFICATION'), ('NEEDS ANALYSIS', 'NEEDS ANALYSIS'), ('VALUE PROPOSITION', 'VALUE PROPOSITION'), ('ID.DECISION MAKERS', 'ID.DECISION MAKERS'), ('PERCEPTION ANALYSIS', 'PERCEPTION ANALYSIS'), ('PROPOSAL/PRICE QUOTE', 'PROPOSAL/PRICE QUOTE'), ('NEGOTIATION/REVIEW', 'NEGOTIATION/REVIEW'), ('CLOSED WON', 'CLOSED WON'), ('CLOSED LOST', 'CLOSED LOST')], default='lead', max_length=50, null=True, verbose_name='Stage')),
